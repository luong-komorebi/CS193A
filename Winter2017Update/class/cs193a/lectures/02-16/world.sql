...
('CHN','China','Asia','Eastern Asia',9572900.00,-1523,1277558000,71.4,982268.00,917719.00,'Zhongquo','PeoplesRepublic','Jiang Zemin',1891,'CN'),
...
CREATE TABLE languages (
  ...
  official varchar(2) NOT NULL default 'F',
